...
class Conversation:
    ...
    def get_choice(self, hint, options):
        while True:
            choice = input(hint)
            ...
            try:
                ...
                if choice == '2':
                    ...
                    if ciphertext.startswith('encrypted:'):
                        plaintext = self.fernet.decrypt(bytes.fromhex(ciphertext[10:]))
    ...
    def prepare(self):
        ...
        if choice == '1':
            ...
            selected_friend_key_name = self.get_choice(
                hint=hint,
            ...
            msg = 'encrypted_secret_key:{}'.format(bytes_to_hex_string(encrypted_secret_key))
        ...
        if choice == '2':
            ...
            while True:
                ...
                if encrypted_secret_key_msg.startswith('encrypted_secret_key:'):
                    break
                else:
                    print('[!] encrypted_secret_key msg must start with "encrypted_secret_key:"')
                    continue
